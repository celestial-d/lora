...
#screen -x -S master -p 0 -X stuff "CUDA_VISIBLE_DEVICES="-1" python3 /home/hpcpuzrzhang/xgpu-scratch/Code/FL_LLMFT/Fed_LoRA/server.py\n"

conda activate FL-PyT-LLMFT
screen -dmS worker_1 
screen -x -S worker_1 -p 0 -X stuff "conda activate FL-PyT-LLMFT\n"
screen -x -S worker_1 -p 0 -X stuff "CUDA_VISIBLE_DEVICES="MIG-8e6c5255-c279-5ecb-b505-7d6b38f0a687" python3 /home/zhazhang/Code/FL_LLMFT/sent/client.py --partition-id=0 --task_id=0\n"

conda activate FL-PyT-LLMFT
screen -dmS worker_2 
screen -x -S worker_2 -p 0 -X stuff "conda activate FL-PyT-LLMFT\n"
screen -x -S worker_2 -p 0 -X stuff "CUDA_VISIBLE_DEVICES="MIG-748fdfbc-251c-597b-8b1d-08961cc8f6ed" python3 /home/zhazhang/Code/FL_LLMFT/sent/client.py --partition-id=1 --task_id=1\n"
